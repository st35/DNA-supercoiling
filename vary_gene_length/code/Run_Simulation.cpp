...
void Run_Simulation(double promoterarg, int argid, int world_rank)
{
	...
	for(int i = 0; i < 16; i++)
	{
		outputfolder = "outputfiles/RUN_" + std::to_string(argid) + "_" + std::to_string(geneid);
